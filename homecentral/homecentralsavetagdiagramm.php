<?php 
	...
	require_once "phplot.php";
 	...
 	# http://www.php.de/datenbanken/103637-phplot-diagramm-speichern.html
...
#$downloadstring = 'HomeDatendiagramm_'.$anzeigetagdesmonats.'_'.$anzeigemonat.'_'.$anzeigejahr.'.jpg';
#$fulldownloadstring = "http://www.ruediheimlicher.ch/Data/".$downloadstring;
#print'*'.$fulldownloadstring.'*';

#  makeDownload($file, $dir, $type)
#readfile($fulldownloadstring);
#makeDownload($downloadstring,'http://www.ruediheimlicher.ch/Data/', $type);


#if(!empty($_GET['file']) && !preg_match('=/=', $_GET['file'])) 
#{
#    if(file_exists ($output_file.$_GET['file']))     
#    {
 #       makeDownload($_GET['file'], $output_file, $type);
 #   }
