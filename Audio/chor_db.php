...
if ($task == 'change')
{
	...
	$nummer = $_POST['changenummer'];
	$teaser = $_POST['changeteaser'];
	$beschreibung = $_POST['changebeschreibung'];
	
	$result_change = mysql_query("UPDATE archiv SET name = '$name', art = '$art', gruppe = '$gruppe', stufe = '$stufe',preis = '$preis',nummer = '$nummer', teaser = '$teaser',beschreibung = '$beschreibung'  WHERE id = '$index'");
	$resultat=mysql_affected_rows($db);
