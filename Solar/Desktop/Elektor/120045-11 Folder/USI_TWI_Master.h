/*****************************************************************************
* mod. for the project "tiny_compass" with WIN-AVR   W. Waetzig  19.04.2011
* Original application AVR310:
* Atmel Corporation
* File              : USI_TWI_Master.h
* Compiler          : IAR EWAAVR 2.28a/3.10a
* Revision          : $Revision: 1.10 $
* Date              : $Date: Thursday, August 25, 2005 11:18:02 UTC $
...
#define SYS_CLK  F_CPU/1000 // 4000.0  // [kHz]
...
#if defined(__AT90Tiny26__) | defined(__AVR_ATtiny26__)
    #define DDR_USI             DDRB
...
#if defined(__AT90Tiny2313__) | defined(__AVR_ATtiny2313__)
    #define DDR_USI             DDRB
    #define PORT_USI            PORTB
    #define PIN_USI             PINB
...
#if defined(__AVR_ATtiny24__) | defined(__AVR_ATtiny84__)
    #define DDR_USI             DDRA
