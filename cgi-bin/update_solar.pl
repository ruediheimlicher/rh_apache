...
$homedatei[3] = "$startDatumstring";
$homedatei[4] = "\n$stunde:$min\n";
$homedatei[5] = "Startzeit: $jahr-$monat-$tag 00:00:$sec +0100\n";
...
my $POSTSolarDatenstring = "http://localhost/public_html/cgi-bin/solar.pl?";

my $scriptstring="http://localhost/public_html/cgi-bin/solar.pl";
my $parameterstring = "";
