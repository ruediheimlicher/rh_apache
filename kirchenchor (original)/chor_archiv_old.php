...
#asort($auftrittlistearray,SORT_STRING);
...
$result_jahrdaten = mysql_query("SELECT * FROM archiv WHERE jahr = '$suchjahr' ORDER BY datum", $db)or die(print '<p  >Beim Suchen nach komponistdaten ist ein Fehler passiert: '.mysql_error().'</p>');
if (mysql_error())
{
	print 'SELECT suchname error:';
	print mysql_error();
