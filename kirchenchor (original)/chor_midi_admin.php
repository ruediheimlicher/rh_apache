	...
	if ($sent == 'yes') 
	{
		...
		if ( isset($_POST['edit']))
		{
			...
			if (isset($_POST['changeradio']))
			{
				...
				$result_idzeile = mysql_query("SELECT * FROM audio WHERE id = $satzid", $db);
				...
				print $changedatensatzstring;
					...
					<table>
						<tr>
							...
							<td><input size="4" maxlength="40" name="aktiv" value ="'.$changeaktiv.'"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input size="40" maxlength="40" name="changeartsatz" value ="'.$changesatz.'"></td>
						</tr>
						<tr>
