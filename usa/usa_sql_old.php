...
print ' <input type="submit" style="font-family:Tahoma,Verdana,Arial,Sans-serif; color:#0000C0; font-size:24pt; margin-left:10px" value="> Home" >';
...
$result_campground = mysql_query("SELECT * FROM campground ", $db);#or die(print '<p  >Beim Suchen nach komponist ist ein Fehler passiert: '.mysql_error().'</p>');
...
print '<form method="POST" action="usa_routen_old.php">';
...
$result_regiondaten = mysql_query("SELECT * FROM campground ", $db)or die(print '<p  >Beim Suchen nach regiondaten ist ein Fehler passiert: '.mysql_error().'</p>');
...
$result_regiondaten = mysql_query("SELECT * FROM campground WHERE region = '$suchregion'", $db)or die(print '<p  >Beim Suchen nach regiondaten ist ein Fehler passiert: '.mysql_error().'</p>');
...

{
	...
	$result_insert = mysql_query("INSERT  INTO campground ( state,  region, name, mail, url, tel, tel_free, ort, rate, adresse, gmap, anmerkung) VALUES ( '$neuerstate', '$neueregion', '$neuername', '$neuemail','$neueurl', '$neuetel', '$neuetel_free', '$neuerort', '$neuerate', '$neueadresse', '$neuegmap', '$neueanmerkung') "); 
...
$result_campgrounddaten = mysql_query("SELECT * FROM campground WHERE id = '$campgroundid'", $db)or die(print '<p  >Beim Suchen nach campgrounddaten ist ein Fehler passiert: '.mysql_error().'</p>');
...
$result_mapdaten = mysql_query("SELECT gmap FROM campground WHERE id = '$campgroundid'", $db)or die(print '<p  >Beim Suchen nach mapdaten ist ein Fehler passiert: '.mysql_error().'</p>');
